...
const ClientHintParser = require('node-device-detector/parser/client-hint-parser');
...
const clientHint = new ClientHintParser();
const port = 3001;
const timeout = 3e5;
...
const middlewareDetect = (req, res) => {
  ...
  res.writeHead(200, ClientHintParser.getHeaderClientHints())
};
