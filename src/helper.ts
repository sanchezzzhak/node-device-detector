import DEVICE_TYPES from './parser/const/device-type';
import DEVICE_TYPE_IDS from './parser/const/device-type-id';
import CLIENT_TYPES from './parser/const/client-type';
 ...
 * @returns {string|null}
 */
export const getDeviceType = (result): string | null => {
 ...
 * @returns {number|null}
 */
export const getDeviceTypeIdForName = (name: string): number | null => {
 ...
 * @returns {number|null}
 */
export const getDeviceTypeId = (result) => {
 ...
 * @returns {string|null}
 */
export const getClientType = (result) => {
 ...
 * @returns {boolean}
 */
export const isFeaturePhone = (result) => {
 ...
 * @returns {boolean}
 */
export const isSmartphone = (result) => {
 ...
 * @returns {boolean}
 */
export const isPortableMediaPlayer = (result) => {
 ...
 * @returns {boolean}
 */
export const isSmartSpeaker = (result) => {
 ...
 * @returns {boolean}
 */
export const isPeripheral = (result) => {
 ...
 * @returns {boolean}
 */
export const isSmartDisplay = (result) => {
 ...
 * @returns {boolean}
 */
export const isWearable = (result) => {
 ...
 * @returns {boolean}
 */
export const isDesktopApp = (result) => {
 ...
 * @returns {boolean}
 */
export const isMobileApp = (result) => {
