module.exports = [
  ...
  {
    "regex": "(CheckerProxy|CMSLookup|CSE-Scanner|DomainProbe|FreePBX-Scanner|Goosee-Audit|NetScope-DomainScanner|SecurityScanner|Shodan-Pull|TLM-Audit-Scanner)",
    "name": "$1",
    "category": "Security Checker"
  },
  {
