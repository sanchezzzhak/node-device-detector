export class ArrayPath {
   ...
   * @returns {*}
   */
  static get(obj, path: string | number[] | string[], defaultValue: any = void 0) {
    ...
    const currentPath = ArrayPath.getKey(path[0]);
  ...
  static set(obj, path, value, doNotReplace) {
    ...
    const currentValue = obj[currentPath] !== void 0 ? obj[currentPath] : void 0;
    if (path.length === 1) {
